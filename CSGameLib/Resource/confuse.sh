...
STRING_SYMBOL_FILE="$PROJECT_DIR/CSGameLib/Resource/func.list"

CONFUSE_FILE="$PROJECT_DIR/CSGameLib"

HEAD_FILE="$PROJECT_DIR/CSGameLib/Resource/codeObfuscation.h"
